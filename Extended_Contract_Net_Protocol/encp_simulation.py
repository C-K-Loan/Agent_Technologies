...
test_agent0= Agent((0,4),5,1,1)
#test_agent1= Agent(5,(3,3),15,20, [0])
test_agent2= Agent((0,4),5,1,1)
...
manager_release_time_list.insert(4,[])
manager_release_time_list.insert(5,[Encp_manager((0,4),agent_list),Encp_manager((3,0),agent_list)])
